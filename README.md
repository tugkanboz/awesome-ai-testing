...
- [MTEB](https://github.com/embeddings-benchmark/mteb) 🆓 - Benchmark for evaluating text and multimodal embedding models across retrieval, clustering, classification, and reranking tasks, backed by a Hugging Face leaderboard.
