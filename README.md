...
- [Weights & Biases Weave](https://github.com/wandb/weave) 🆓💰 - Toolkit from Weights & Biases for tracing, evaluating, and iterating on LLM applications with a structured evaluation workflow.
...
- [NeMo Guardrails](https://github.com/NVIDIA/NeMo-Guardrails) 🆓 - NVIDIA's open-source toolkit for adding programmable safety guardrails to LLM-based conversational applications.
