...
- [FuzzyAI](https://github.com/cyberark/FuzzyAI) 🆓 - Automated LLM fuzzing tool from CyberArk that runs a library of jailbreak and attack techniques against LLM APIs to identify safety vulnerabilities before deployment.
...
- [LiveBench](https://github.com/livebench/livebench) 🆓 - Contamination-free LLM benchmark that releases new questions monthly from recent math competitions, arXiv papers, and news articles, with automatic ground-truth scoring across reasoning, coding, and language tasks.
