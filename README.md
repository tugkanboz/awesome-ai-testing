...
- [AgentOps](https://github.com/AgentOps-AI/agentops) 🆓 - Python SDK for AI agent observability and evaluation with session replays, LLM cost tracking, and native integrations for CrewAI, AutoGen, and the OpenAI Agents SDK.
...
- [PurpleLlama](https://github.com/meta-llama/PurpleLlama) 🆓 - Meta's open toolkit for responsible LLM development, providing Llama Guard for harmful content detection, Prompt Guard for injection protection, and CyberSecEval benchmarks for cybersecurity risk evaluation.
