...
- [BFCL (Berkeley Function-Calling Leaderboard)](https://github.com/ShishirPatil/gorilla/tree/main/berkeley-function-call-leaderboard) 🆓 - UC Berkeley's comprehensive benchmark for evaluating LLMs on real-world function calling and tool use, covering single-turn, multi-turn, multi-step, and agentic scenarios across thousands of expert-curated API calls.
...
- [EvalPlus](https://github.com/evalplus/evalplus) 🆓 - Rigorous code generation evaluation framework that extends HumanEval and MBPP with 80x and 35x more automated tests respectively, reducing false-positive pass rates when benchmarking coding LLMs.
