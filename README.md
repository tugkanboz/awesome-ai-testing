...
- [CyberSecEval](https://github.com/meta-llama/PurpleLlama) 🆓 - Meta's cybersecurity safety evaluation suite for LLMs, covering insecure code generation, prompt injection susceptibility, and autonomous offensive cyber operation tests aligned with CWE and MITRE ATT&CK.
...
- [MLE-bench](https://github.com/openai/mle-bench) 🆓 - OpenAI benchmark for evaluating AI agents on machine learning engineering tasks drawn from 75 real Kaggle competitions.
