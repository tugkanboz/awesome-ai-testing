...
- [Adversarial Robustness Toolbox](https://github.com/Trusted-AI/adversarial-robustness-toolbox) 🆓 - Linux Foundation toolkit for evaluating and defending ML models against evasion, poisoning, extraction, and inference attacks.
...
- [LiveBench](https://github.com/LiveBench/LiveBench) 🆓 - Contamination-free LLM benchmark with monthly-updated questions across 18 tasks and 6 categories, designed for objective evaluation without data leakage.
